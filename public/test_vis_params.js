...
import testVisParamsTemplate from './test_vis_params.html';
const module = uiModules.get('kibana');

// module.directive('testVisParams', function () {
//   return {
//     restrict: 'E',
//     template: testVisParamsTemplate,
//     replace: true,
//     // link: function ($scope) {
...
//
// class TestVisParams extends Component {
//
//   hideData = () => {
//     console.log('PARAMS PROPS ',this.props.scope.vis.params.hideMe);
//     // console.log('PARAMS PROPS ',this.props);
//     this.props.scope.vis.params.hideMe = !this.props.scope.vis.params.hideMe;
//     console.log('PARAMS PROPS ',this.props.scope.vis.params.hideMe);
//   };
//
//   render() {
//     return (
//       <div>
//         <div>test react params</div>
//         <button onClick={this.hideData} type="button">hide</button>
//       </div>
//     );
//   }
//
